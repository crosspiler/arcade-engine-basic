import {
  ...
  PostProcess
} from "./chunk-KZBLVGZE.js";
import {
  DumpDataAsync
} from "./chunk-ADFHVXOZ.js";
import {
  SphericalPolynomial
} from "./chunk-XQZGOR2M.js";
import {
  BaseTexture
} from "./chunk-VEJWL4DR.js";
import {
  Scene
} from "./chunk-YQW3U5C7.js";
import {
  Tools
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-RZH7AROD.js");
      } else {
        await import("./rgbdDecode.fragment-ZPFFE6DQ.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-4FWM3LBA.js");
    } else {
      await import("./rgbdEncode.fragment-VEKFIH6R.js");
    }
...
//# sourceMappingURL=chunk-N5EXPSWE.js.map
