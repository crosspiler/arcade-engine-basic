import {
  EffectWrapper
} from "./chunk-OEOLFXFS.js";
import {
  Engine,
  SphericalHarmonics,
  SphericalPolynomial
} from "./chunk-XQZGOR2M.js";
import {
  Texture
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-IONHPCGX.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-YP2PKOTW.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-XJB3QOGO.js")]));
    }
  }
  /**
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-SRV7OVYF.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-KYF2HLMD.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-3KRRRNBN.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-3YA7BKRP.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-NWINMPQO.js");
    } else {
      await import("./lod.fragment-OAJBQBJK.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-LQMMMT2Q.js");
    } else {
      await import("./lod.fragment-N4S7VUDL.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-KZBLVGZE.js.map
